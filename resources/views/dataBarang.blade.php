                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="p-4">Harga Barang</th>
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="{{ route('tambahBarang') }}" method="post">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="harga_barang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Barang</label>
                                <input type="number" name="harga_barang" id="harga_barang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan harga barang ..." required="">
                            </div>
                            <div>
